			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						{% if user.is_admin %}<a href="{{rooturl}}/boss/edit/id={{boss.id}}&iid={{boss.instance_id}}" class="modalform" title="Boss Bearbeiten"><img src="{{theme_url}}/images/icons/page_edit.png"></a>{% endif %}
					</td>
