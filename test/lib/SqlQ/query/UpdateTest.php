...
class SqlS_QueryUpdateTest extends PHPUnit_Framework_TestCase {
    var $table = 'testTable';
    ...
    function testArgsTableFieldsPK() {
        $sql = new SqlS_QueryUpdate($this->table, $this->fields, $this->pk);
    ...
    function testArgsTableFields() {
        $sql = new SqlS_QueryUpdate($this->table, $this->fields);
