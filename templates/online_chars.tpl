...
{% block content %}
<b/>Online Players:<b>{{ chars_count }}</b><br>
<font color="lightblue" size="-1,5">Online Allianz: <b> {{ ally_count }}</b></font>|
<font color="red" size="-1,5"> Online Horde: <b>{{ horde_count }}</b></font>
